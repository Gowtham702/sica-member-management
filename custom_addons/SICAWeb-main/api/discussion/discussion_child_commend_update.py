...
endpoint = '/update/child/discussion_comment'  # Endpoint defined in your Odoo controller
...
data = {"comment": "4321", "document":"", "membership_no":"0024", "child_comment_id": "1"}

# Prepare the full URL
url = f'{base_url}{endpoint}?db={database_name}&api_key={api_key}&MEMBERSHIP_ID={MEMBERSHIP_ID}&data={data}&COMMENT_ID={COMMENT_ID}' # Include the api_key parameter in the query string
print(url)
