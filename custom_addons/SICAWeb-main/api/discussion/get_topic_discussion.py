...
endpoint = '/get/topic/discussion'  # Endpoint defined in your Odoo controller
...
url = f'{base_url}{endpoint}?db={database_name}&api_key={api_key}&topic_id={"2"}'  # Include the api_key parameter in the query string
print(url)
