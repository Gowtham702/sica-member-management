...
endpoint = '/get/all/category/events'  # Endpoint defined in your Odoo controller
...
url = f'{base_url}{endpoint}?db={database_name}&api_key={api_key}&category_id={category_id}'  # Include the api_key parameter in the query string
print(url)
