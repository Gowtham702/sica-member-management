...
endpoint = '/get/all/events'  # Endpoint defined in your Odoo controller
...
url = f'{base_url}{endpoint}?db={database_name}&api_key={api_key}&member_number={member_number}'  # Include the api_key parameter in the query string
print(url)
