...
endpoint = '/get/gallery'  # Endpoint defined in your Odoo controller
...
url = f'{base_url}{endpoint}?db={database_name}&api_key={api_key}&category_id={category_id}&MEMBERSHIP_ID={MEMBERSHIP_ID}'
print(url)
