...
endpoint = '/post/gallery/delete/comment'  # Endpoint defined in your Odoo controller
...
gallery_id = 1
data = {"member_id" : "0024", "member_name": "muthu", 'comment': "CC", "comment_id": 6}
# Prepare the full URL
url = f'{base_url}{endpoint}?db={database_name}&api_key={api_key}&gallery_id={gallery_id}&data={data}'
print(url)
