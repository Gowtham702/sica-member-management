...
endpoint = '/get/all/member/match_job_seeker'  # Endpoint defined in your Odoo controller
...
url = f'{base_url}{endpoint}?db={database_name}&api_key={api_key}&MEMBERSHIP_ID={MEMBERSHIP_ID}&job_provide_id={job_provide_id}'  # Include the api_key parameter in the query string
print(url)
