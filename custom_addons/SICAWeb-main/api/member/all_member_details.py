...
endpoint = '/get/all/member_details'  # Endpoint defined in your Odoo controller
...
url = f'{base_url}{endpoint}?db={database_name}&api_key={api_key}&offset={offset}&limit={limit}' # Include the api_key parameter in the query string
print(url)
