...
endpoint = '/create/shooting_associate'  # Endpoint defined in your Odoo controller
...
MEMBERSHIP_ID = '0024'
SHOOTING_ID = '3'
data = {"name": "Animal Photo", "mobile_number": "2023", "member_number": "0024"}

# Prepare the full URL
url = f'{base_url}{endpoint}?db={database_name}&api_key={api_key}&MEMBERSHIP_ID={MEMBERSHIP_ID}&shooting_id={SHOOTING_ID}&data={data}' # Include the api_key parameter in the query string
print(url)
