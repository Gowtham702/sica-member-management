...
endpoint = '/update/shooting_associate'  # Endpoint defined in your Odoo controller
...
MEMBERSHIP_ID = '0024'
ASSOCIATE_ID = '1'
data = {"name": "Animal ", "mobile_number": "2022543", "member_number": "0024"}

# Prepare the full URL
url = f'{base_url}{endpoint}?db={database_name}&api_key={api_key}&MEMBERSHIP_ID={MEMBERSHIP_ID}&Associate_id={ASSOCIATE_ID}&data={data}' # Include the api_key parameter in the query string
print(url)
