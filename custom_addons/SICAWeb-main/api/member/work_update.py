...
endpoint = '/update/work_details'  # Endpoint defined in your Odoo controller
...
data = {"project_name" : "Animal gdfg", "year": "2023", "designation": "bfghfhf gg tg t"}

# Prepare the full URL
url = f'{base_url}{endpoint}?db={database_name}&api_key={api_key}&MEMBERSHIP_ID={MEMBERSHIP_ID}&data={data}&ID={ID}' # Include the api_key parameter in the query string
print(url)
