...
endpoint = '/otp/verify'  # Endpoint defined in your Odoo controller
...
url = f'{base_url}{endpoint}?db={database_name}&api_key={api_key}&OTP={OTP}&access_token={access_token}'  # Include the api_key parameter in the query string
print(url)
