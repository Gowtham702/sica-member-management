...
endpoint = '/get/title/shooting_details'  # Endpoint defined in your Odoo controller
...
url = f'{base_url}{endpoint}?db={database_name}&api_key={api_key}&shooting_title={"Murugsn2"}' # Include the api_key parameter in the query string
print(url)
