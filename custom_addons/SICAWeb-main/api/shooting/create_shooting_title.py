...
endpoint = '/create/shooting_title'  # Endpoint defined in your Odoo controller
...
url = f'{base_url}{endpoint}?db={database_name}&api_key={api_key}&MEMBERSHIP_ID={MEMBERSHIP_ID}&data={{"title_name" : "Murugan" }}'
print(url)
