...
endpoint = '/gat/dop/pending/shooting_approval'  # Endpoint defined in your Odoo controller
...
url = f'{base_url}{endpoint}?db={database_name}&api_key={api_key}&DOP_MEMBERSHIP_ID={MEMBERSHIP_ID}' # Include the api_key parameter in the query string
print(url)
