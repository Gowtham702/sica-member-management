...
endpoint = '/get/spd/sub/category/product'  # Endpoint defined in your Odoo controller
...
url = f'{base_url}{endpoint}?db={database_name}&api_key={api_key}&sub_category_id={sub_category_id}'  # Include the api_key parameter in the query string
print(url)
